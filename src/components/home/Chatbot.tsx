...
export default function Chatbot() {
  return (
    <div className='container mx-auto font-poppins text-white' data-aos="fade-up" data-aos-duration="900">
      <div className="bg-[linear-gradient(170deg,_#BDFF00_0%,_#00AD03_81%)] flex lg:flex-row flex-col items-center lg:justify-between justify-center w-[86vw] mx-auto min-h-[20vh] lg:py-6 py-10 lg:px-20 px-6 mb-24 rounded-lg">
        ...
        <Link href="/chatbot">
          <button className='bg-white border-2 border-white rounded-full cursor-pointer hover:bg-transparent duration-300 group px-10 py-2 lg:mt-0 mt-12'>
            <p className='bg-clip-text bg-[linear-gradient(170deg,_#BDFF00_0%,_#00AD03_81%)] group-hover:text-white duration-300 text-transparent text-[16px] lg:text-[20px] font-[600]'>Coba</p>
          </button>
        </Link>
      </div>
    </div>
