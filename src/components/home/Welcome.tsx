...
export default function Welcome() {
  return (
    <div className='flex flex-col items-center justify-start min-h-screen font-poppins lg:my-10 my-6 container lg:pb-0 pb-20 mx-auto'>
      <div className="w-[95vw] h-[84vh] bg-cover flex relative justify-between items-center display-none" style={{ backgroundImage: `url(${bgWelcome.src})` }} data-aos="fade-up" data-aos-duration="800">
        ...
        <Image src={search.src} className='absolute cursor-pointer hover:scale-105 scale-100 duration-300 left-0 bottom-0' width={500} height={300} alt='image'/>
      </div>
