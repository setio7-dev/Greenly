...
export default function Welcome() {
  return (
    <div className='flex flex-col items-center justify-start min-h-screen font-poppins lg:my-10 my-6 container lg:pb-0 pb-20 mx-auto'>
      <div className="w-[95vw] h-[84vh] bg-cover flex relative justify-between items-center display-none" style={{ backgroundImage: `url(${bgWelcome.src})` }}>
        <h1 className='font-[700] -mt-30 text-[48px] ml-20 text-white'>Jelajahi Gaya Hidup <br /> Rendah Emisi</h1>
        <Image src={truck.src} width={640} height={640} alt='image'/>
        <Image src={search.src} className='absolute left-0 bottom-0' width={500} height={300} alt='image'/>
      </div>
      <div className="min-h-screen w-full flex flex-col justify-center px-4 items-center gap-6 display-flex">
        <div className="flex flex-col gap-4 -mt-12">
          <Image src={truck.src} width={300} height={300} className='mx-auto' alt='image'/>
      ...
      <div className="flex lg:flex-row flex-col justify-center items-center lg:gap-16 gap-6 lg:mt-20 -mt-6">
        <Image src={suggest} className='lg:w-[550px] w-[280px]' width={550} height={500} alt='suggest'/>
        <div className="flex flex-col items-start lg:w-[520px] w-[320px]">
