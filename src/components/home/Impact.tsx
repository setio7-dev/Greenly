  ...
  return (
    <div className="h-auto pb-20 font-poppins text-white">
        <div className='flex lg:flex-row flex-col justify-center items-center lg:gap-12 gap-8 lg:px-0 px-4'>
          <div className="lg:w-[500px] w-full lg:h-[530px] h-[420px] bg-[linear-gradient(150deg,_#BDFF00_0%,_#00AD03_80%)] rounded-md py-18 lg:px-14 px-8">
          ...
          <div className="flex flex-col gap-6">
            <div className="flex lg:flex-row flex-col justify-center items-center lg:gap-12 gap-8">
                <div className="lg:w-[280px] w-full h-[400px] bg-[linear-gradient(150deg,_#BDFF00_0%,_#00AD03_80%)] rounded-md px-10 flex flex-col justify-center items-start gap-4">
            ...
            <div className="p-[4px] h-auto lg:w-full w-[80vw] mx-auto rounded-xl bg-[linear-gradient(170deg,_#BDFF00_0%,_#00AD03_80%)]">
        ...
        <div className="w-full lg:h-screen h-[170vh] object-cover bg-cover -mt-12" style={{backgroundImage: `url(${background.src})`}}>
            <div className="bg-white rounded-b-lg w-[94vw] h-[58vh] flex flex-col justify- gap-10 pt-26 mx-auto">
                <div className="flex lg:flex-row flex-col lg:justify-between justify-center items-center lg:gap-0 gap-2 lg:px-20 px-6">
                    <p className='lg:text-[42px] lg:w-[320px] w-full lg:text-start text-center text-[24px] font-[700] text-transparent bg-clip-text bg-[linear-gradient(170deg,_#BDFF00_0%,_#00AD03_51%)]'>DAMPAK POLUSI UDARA</p>
                    <p className='lg:text-end text-center lg:text-[18px] text-[12px] text-black lg:w-[600px] w-auto'>Perubahan iklim membuat suhu global naik, memicu gelombang panas, kekeringan ekstrem, dan kebakaran hutan lebih sering.</p>
                </div>
                <div className="flex lg:flex-row flex-col justify-center items-center gap-10">
                    {ImpactData.map((item) => (
                        <div key={item.id} className="lg:w-[360px] w-[280px] duration-200 h-auto px-6 py-12 shadow-2xl rounded-lg border-4 border-gray-200 hover:border-[#00AD03] cursor-pointer bg-white text-black flex flex-col gap-6">
