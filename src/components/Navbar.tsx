...
export default function Navbar() {
  ...
  return (
    <div className="flex justify-center items-center font-poppins text-black h-[14vh] gap-90 fixed w-full bg-white z-30">
      <h1 className='font-[600] text-[26px]'>Jejak Bumi</h1>
      <div className="flex justify-center items-center gap-8 text-[18px] font-[500]">
          ...
          <a href="#" className="relative before:absolute before:-bottom-1 before:left-0 before:w-0 before:h-[2px] before:bg-[linear-gradient(90deg,#98CD00_18%,#B6F500_80%)] hover:before:w-full before:transition-all before:duration-300">Ancaman</a>
          <a href="#" className="relative before:absolute before:-bottom-1 before:left-0 before:w-0 before:h-[2px] before:bg-[linear-gradient(90deg,#98CD00_18%,#B6F500_80%)] hover:before:w-full before:transition-all before:duration-300">Aksi</a>
          <a href="#" className="relative before:absolute before:-bottom-1 before:left-0 before:w-0 before:h-[2px] before:bg-[linear-gradient(90deg,#98CD00_18%,#B6F500_80%)] hover:before:w-full before:transition-all before:duration-300">Komunitas</a>
          <a href="#" className="relative before:absolute before:-bottom-1 before:left-0 before:w-0 before:h-[2px] before:bg-[linear-gradient(90deg,#98CD00_18%,#B6F500_80%)] hover:before:w-full before:transition-all before:duration-300">AI Chat</a>
