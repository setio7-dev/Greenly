...
import community1 from '../../../public/image/air/community1.png'
import community2 from '../../../public/image/air/community2.png'
import community3 from '../../../public/image/air/community3.png'
        ...
        <div className="grid lg:grid-cols-3 grid-cols-1 gap-10 lg:gap-20 mt-16">
          {CommunityData.map((item) => (
            <div className="bg-[#D9D9D9] lg:w-[240px] w-[300px] h-[300px] pb-6 flex flex-col justify-center items-center rounded-md" key={item.id} data-aos="fade-up" data-aos-duration="800" data-aos-delay="100">
              ...
              <button className='bg-[radial-gradient(circle,_#6BB3F6_0%,_#7597B8_100%)] text-white px-10 py-2 cursor-pointer rounded-lg text-[16px]'>Bergabung</button>
            </div>
          ))}
        </div>
      </div>
