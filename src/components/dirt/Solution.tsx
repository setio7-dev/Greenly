...
import { DirtAccordion } from '@/app/data/Accordion'
import Image from 'next/image';
import solution from '../../../public/image/dirt/solution.png'
...
export default function Solution() {
  ...
  return (
    <div className='font-poppins min-h-screen flex flex-col items-center pb-28 lg:px-0 px-6 lg:-mt-12 -mt-26' id='aksi'>
      ...
      <h1 data-aos="fade-up" data-aos-duration="800" data-aos-delay="200" className='lg:text-[24px] text-[20px] mt-18 w-fit font-[600] text-white lg:px-14 px-8 py-2 rounded-xl bg-[radial-gradient(circle,_#810000_0%,_#5C0000_100%)]'>SOLUSI PENANGANAN</h1>
      <div className="mt-[60px]">
        <div className='flex lg:flex-row flex-col lg:items-start items-center justify-center lg:gap-[40px] gap-8' data-aos-duration="800">
          <div data-aos="fade-up" data-aos-duration="900">
            <Image src={solution} width={500} height={500} alt='solution' className='lg:w-[500px] w-[280px] h-auto rounded-2xl transition-transform duration-500 hover:scale-105'/>
          </div>
          <div className=''>
