...
export default function Fact() {
  return (
    <div className='flex flex-col items-center font-poppins min-h-screen mb-20 lg:-mt-12 mt-0 lg:px-0 px-6'>
      <h1 className="font-[600] lg:text-[32px] text-[24px] lg:text-start text-center">
      ...
      <div className="flex lg:flex-row flex-col justify-center items-center gap-12 text-white">
        <div className="flex flex-col mt-16 justify-center items-center lg:gap-28 gap-46">
          <div className="bg-cover relative object-cover w-[320px] lg:w-[580px] lg:h-[180px] h-[100px] flex justify-center items-center gap-6" style={{backgroundImage: `url('/image/tree/comment.png')`}}>
        ...
        <div className="bg-cover relative object-cover w-[320px] lg:w-[580px] lg:h-[180px] h-[100px] lg:mt-0 -mt-72 flex justify-center items-center gap-6" style={{backgroundImage: `url('/image/tree/comment-reverse.png')`}}>
