...
export default function Threat() {
  ...
  return (
    <div className='flex justify-center lg:flex-row flex-col items-center gap-16 lg:mt-0 -mt-60 font-poppins min-h-auto mb-28'>
      <h1 className='lg:text-[42px] text-[30px] lg:text-start text-center font-[700] text-transparent bg-clip-text bg-[linear-gradient(160deg,_#BDFF00_0%,_#00AD03_81%)]'>ANCAMAN <br /> PENCEMARAN</h1>
